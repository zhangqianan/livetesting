  ...
  <div class="user-application" v-if="token">
    ...
    <div class="user-application-center">
      ...
      <div class="user-application-center-center">
        ...
        <div class="user-application-center-center-one" v-if="mobile !== ''">
          <div class="user-application-center-center-one-box"><label>手机号</label></div>
          <div class="user-application-center-center-one-boxs"><input type="text" disabled="disabled" v-model="mobile" class="user-application-center-center-one-boxs-input"></div>
        </div>
        <div class="user-application-center-center-one" v-if="cardNo !== ''">
          <div class="user-application-center-center-one-box"><label>银行卡号</label></div>
          <div class="user-application-center-center-one-boxs"><input type="text" disabled="disabled" v-model="cardNo" class="user-application-center-center-one-boxs-input"></div>
        </div>
...
<script>
  import { getQrCodePerson } from '@/network/home'
  export default {
    name: 'Personal',
    data() {
      return {
